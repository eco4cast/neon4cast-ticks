...
if(file.exists(here("Exploratory_Data/data/Tick_all.Rdata"))){
...
saveRDS(tck_site_species_table, here("Exploratory_Data/data/tck_sitexspecies.Rdata"))
saveRDS(tck_site_species_env,  here("Exploratory_Data/data/tck_sitexspecies_env.Rdata"))
saveRDS(tck_merged_final,  here("Exploratory_Data/data/tck_longform.Rdata"))
