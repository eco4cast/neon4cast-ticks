...
### Script to reformat NEON tick abundances into ecocomDP formatting
# uses the data from script 01_download_clean_NEON_tick.R (downloads, cleans, links NEON tick data)
...
tick_long <- readRDS(here("Exploratory_Data/data/tck_longform.Rdata"))
tick_site_env <- readRDS(here("Exploratory_Data/data/tck_sitexspecies_env.Rdata"))
...
readr::write_csv(
  tick_location,
  here('Exploratory_Data/data/tick_table_location.csv'))

readr::write_csv(
  tick_location_ancillary,
  here('Exploratory_Data/data/tick_table_location_ancillary.csv'))

readr::write_csv(
  tick_observation_table,
  here('Exploratory_Data/data/tick_table_observation.csv'))

readr::write_csv(
  tick_observation_ancillary,
  here('Exploratory_Data/data/tick_table_observation_ancillary.csv'))

readr::write_csv(
  tick_taxon,
  here('Exploratory_Data/data/tick_table_taxon.csv'))
